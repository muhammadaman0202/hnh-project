...
export default class Casestudy extends Component {
  ...
  <section id="up" className="page-head flex-min-height-box dark-bg-2 typewriter-home">
    {/* page-head-bg */}
    <div className="page-head-bg" style={{backgroundImage: 'url(assets/images/backgrounds/brody-childs-KyxQV47s9Jw-unsplash.jpg)'}} />
    <div className="bg-overlay" />
    {/* flex-min-height-inner start */}
    <div className="flex-min-height-inner">
      {/* container start */}
      <div className="container top-bottom-padding-120">
        <h2 className="overlay-loading2 medium-title red-color">Case</h2>
        <h3 className="large-title-bold text-color-4">
          <span className="overlay-loading2 overlay-light-bg-1 tr-delay01">Study</span><br />
        </h3>
  ...
  {/* section start */}
  <section className="light-bg-1" id="down" data-midnight="black">
    {/* container start */}
    <div className="container bottom-padding-60 top-padding-120">
      {/* text-center start */}
      <div data-animation-container className="text-center">
        <h2 data-animation-child className="large-title text-height-10 text-color-1 overlay-anim-box2" data-animation="overlay-anim2">Case Studies</h2><br />
        <p data-animation-child className="fade-anim-box tr-delay02 text-color-1 small-title-oswald top-margin-5" data-animation="fade-anim">Our pride stems from creating the exhilarating digital experiences for our clients and their customers.</p>
      </div>{/* text-center end */}
      {/* flex-container start */}
      <div className="flex-container response-999 top-padding-60">
        {/* column start */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="360app.php" className="content-right-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              <h3 data-animation-child className="medium-title-oswald text-color-1 hover-content fade-anim-box tr-delay01" data-animation="fade-anim">360 Website and Mobile App</h3><br />
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An ecommerce mobile app aim at providing an immersive and unique experience that makes online shopping a much simpler and seamless process.</p>
            </div>
          </a>
        </div>{/* column end */}
        {/* column start */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="amnayaapp.php" className="content-left-right-margin-10 hover-box pointer-large d-block light-bg-2">
            <div data-animation-child className="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
              <img className="hover-img" src="assets/images/project/amnaya/iportfolio.png" alt="Digital products" />
            </div>
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              <h3 data-animation-child className="medium-title-oswald text-color-1 hover-content fade-anim-box tr-delay01" data-animation="fade-anim">Amnaya App</h3><br />
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">A web and app base open content online botanical encyclopedia created through the collaborative effort of a community of users known as contributor, reader and admin</p>
            </div>
          </a>
        </div>{/* column end */}
        {/* column start */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="americren.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            <div data-animation-child className="overlay-anim-box2 overlay-dark-bg-2 expertise-img-box" data-animation="overlay-anim2">
              <img className="hover-img" src="assets/images/project/americren_app/iportfolio.png" alt="Digital products" />
            </div>
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              <h3 data-animation-child className="medium-title-oswald text-color-1 hover-content fade-anim-box tr-delay01" data-animation="fade-anim">Americren App</h3><br />
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">The American Consumer Real Estate Network. Americren is the first and only web site dedicated with quickly and easily connecting the consumer with the top producing Realtor or Real Estate Agent in the consumer’s marketplace.</p>
            </div>
          </a>
        </div>{/* column end */}
        {/* column start */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="hemid.php" className="content-right-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">With the use of our creative 3D visualization skills and Virtual Reality design, It helps you as an architect, interior designer,</p>
            </div>
          </a>
        </div>{/* column end */}
        {/* column start */}
        ...
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="cornic.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">Cornic is an online gambling website offering sports betting and casino type games. Cornic also offers an on-course bookmaking service.</p>
            </div>
          </a>
        </div>{/* column end */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="cyptogram.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">Cryptogram is an app base project for crypto currencies trading and exchange where traders, financial experts and investors’ meets at a common platform, </p>
            </div>
          </a>
        </div>{/* column end */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="drivementor.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">DriveMentor is a professional website perfect for driving instructors or other training professionals. It is also a service booking web for finding driving instructors for all over the UK with trainee and trainer portals.</p>
            </div>
          </a>
        </div>{/* column end */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="eastwestfurniture.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An ecommerce website aim at providing an immersive and unique experience that makes online furniture shopping a much simpler and seamless process. </p>
            </div>
          </a>
        </div>{/* column end */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="ezigo.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">Ezigo is an app-based car service that connects people to rides. The Company designs an online booking platform that connects passengers with local drivers.</p>
            </div>
          </a>
        </div>
        {/* column end */}
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="farmer.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">A Farmer App is a type of app and website where the content is presented in reverse chronological order (newer content appear first). </p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="tradeday.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">Trade Day is one of the popular cryptocurrency exchanges that offers trading in more than 45 virtual coins including Bitcoin (BTC), Ethereum (ETH), Litecoin (LTC)</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="jeepsapp.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">The S.M Motors is a complete ecommerce portal for online Car Parts Store UK. Customers can find a variety of genuine &amp; replacement</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="jeepsweb.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              <h3 data-animation-child className="text-color-1 hover-content fade-anim-box tr-delay01" data-animation="fade-anim">jeep Unlimited</h3><br />
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">The S.M Motors is a complete ecommerce portal for online Car Parts Store UK. Customers can find a variety of genuine &amp; replacement car parts at our website where they can conveniently</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="jks.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">a FASHION MARKETPLACE where fashion enthusiasts come together to BUY AND SELL designer brands, labels and accessories from TOP DESIGNERS AND BRANDS.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="likeheartedtribe.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An online counseling booking service provides renowned psychologists, psychiatrists to contribute their thoughts and ideas.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="klinvesto.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An Online Asset allocation and investment website which provides a portal for investors and fund managers to interact each other to grow their investment it includes latest web design techniques,</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="legalland.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">A corporate website for a law firm which provides legal information and services rendered by lawyers and solicitors.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="safetyworkerapp.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An online app for safety hazards at workplace specifically design with online alerts, warnings and safety measures while exploring mercury.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="ateamtransport.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">ATEAM Transport Services is a Veteran-Owned non-emergency medical transportation (NEMT) company based in Indianapolis, Indiana. At ATEAM,</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="attendancemanagementsystem.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An online portal of students’ attendance and leave management system lets you handle complex tasks with easy-to-use automation tools.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="photography.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An online service booking platform for finding and hiring professional photographer after looking at their portfolios and albums.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="pslsoftball.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">An online platform to participate different regional teams for baseball tournaments in different seasons to win and bid points including complete data base with statistical analysis.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="stately.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">A Fashion designing online service and delivery website to assists with the production of clothing, shoes and accessories, identifies trends, and selects styles, fabrics, colors, prints and trims for a collection as per customers requirement.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="inventorymanagement.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">Inventory management software to regulate stock levels, control assets and inventory, and manage consumables in and out of the company</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
        ...
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="stormbrown.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">A call detail record (CDR) provides information about calls made over a phone service. A CDR report can offer businesses exact answers about where, when, and how calls are made for reporting and billing purposes.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="tekkertv.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">It is a fun app that allows for creating and sharing short lip-sync, comedy, and talent videos.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="wemalta.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">We Malta is an online marketplace and logistics website. It operates e-commerce platforms and logistics services in Malta. Vendors can register themselves and open their stores online and display their products and services.</p>
            </div>
          </a>
        </div>
        <div className="four-columns bottom-padding-60">
          <a data-animation-container href="opdapp.php" className="content-left-margin-20 hover-box pointer-large d-block light-bg-2">
            ...
            <div className="expertise content-padding-l-r-20 content-padding-bottom-20">
              ...
              <p data-animation-child className="p-style-small text-color-1 hover-content fade-anim-box tr-delay02" data-animation="fade-anim">OPD is more than an app for finding doctors. Whether it’s booking doctor appointments, ordering medicines, scheduling diagnostic tests or having an online consultation with your doctor, </p>
            </div>
          </a>
        </div>
